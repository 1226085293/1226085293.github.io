...
<AutoSizeImage src="https://img-blog.csdnimg.cn/20200402025028894.png" />

看到了吗， \_Thrd_id()其实是一个 uint32_t 类型的返回值，但是却被转换成了 thread::id 类型，
那么我们再来看看 thread::id 这个类里面有什么吧。

<AutoSizeImage src="https://img-blog.csdnimg.cn/20200402025412190.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzI4Mzk4MzAx,size_16,color_FFFFFF,t_70" />
