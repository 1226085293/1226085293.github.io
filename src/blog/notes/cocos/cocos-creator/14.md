...
export class main extends Component {
	...
	protected update(dt: number): void {
		...
		this.nodes.move_point.worldPosition = this.nodes.move_point.worldPosition.clone().lerp(this._target_position_v3, dt * 10);

		if (this.nodes.move_point.worldPosition.clone().subtract(this._target_position_v3).lengthSqr() < 4) {
			this._move_b = false;
		}
	}
