import{_ as n,r as i,o as s,c as d,e as a,a as l,f as r}from"./app-8debb0ca.js";const v={},c=r(`<p>因为看不惯 Mixins 的多继承写法， 于是写了个类装饰器实现</p><div class="language-auto line-numbers-mode" data-ext="auto"><pre class="language-auto"><code>/**扩展合并 */
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="觉得很赞-分享给你的朋友吧" tabindex="-1"><a class="header-anchor" href="#觉得很赞-分享给你的朋友吧" aria-hidden="true">#</a> 📣 觉得很赞？分享给你的朋友吧！</h2>`,7);function t(u,m){const e=i("Share");return s(),d("div",null,[a(" more "),c,l(e,{services:"qq,qrcode",colorful:""})])}const b=n(v,[["render",t],["__file","装饰器：实现多继承.html.vue"]]);export{b as default};
