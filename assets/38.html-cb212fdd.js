import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as n,o,c as r,e as i,a as s,b as e,d as a,f as l}from"./app-ecefdaf5.js";const d={},v=l(`<p>它不是标准化的。有些使用.tcc（t =模板，cc = C ++源代码），<br> 有些使用.icc（i =包含，cc = C ++源代码），有些使用.h（但这<br> 使其与“真实”标头没有区别），有些则只是使用<br> 根本不用额外的文件。它通常是一个文件，其中包含<br> 在标头中声明的模板的实现，标头随后包含#tcc（或<br> 任何其他名称）文件。但是由于对此没有标准或普遍共识<br> ，因此也可能是其他任何事情。<br> 这只是需要<br> 在大多数编译器使用它们的所有翻译单元中可见模板定义的人工</p><p>产物：==== example.hpp ====</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">ifndef</span> <span class="token expression">EXAMPLE_HPP</span></span>
