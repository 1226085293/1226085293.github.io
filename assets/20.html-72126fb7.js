import{_ as n,o as s,c as a,e as t,f as p}from"./app-8131941e.js";const e={},c=p(`<p>因为被多线程搞的有点头痛，所以想了一个简单的办法，不用自己手动加锁，也免去了使用 raii 机制，直接传递一个 std::function 即可.  仅做参考</p><p>代码：</p><p>raii_critical.h</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code>​
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个最重要的功能还是退出标记，可以防止析构后其他进程仍在操作已销毁的对象造成异常。不过不能传参，局限性很大</p>`,9);function o(i,l){return s(),a("div",null,[t(" more "),c])}const r=n(e,[["render",o],["__file","20.html.vue"]]);export{r as default};
