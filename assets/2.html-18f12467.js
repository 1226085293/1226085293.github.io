...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>按照上面的方式就可以暂停所有当前系统内运行的对象，但不会对新增的节点暂停，如果需要排除暂停节点，就需要手动恢复了</p><h2 id="代码-福音书" tabindex="-1"><a class="header-anchor" href="#代码-福音书" aria-hidden="true">#</a> # 代码（福音书）</h2><p>内部除了游戏全局的暂停和恢复，还提供了排除暂停节点，以及单个节点的暂停和恢复</p><p><a class="attachment" href="/uploads/short-url/5UZSqkBXUApXjAsrYWMkj2izo9e.zip">game.zip</a> (1.5 KB)</p>`,26);function r(t,c){return a(),i("div",null,[s(" more "),l])}const m=e(d,[["render",r],["__file","2.html.vue"]]);export{m as default};
