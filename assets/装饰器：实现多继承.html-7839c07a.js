import{_ as e,o as n,c as i,d as s,f as d}from"./app-4c5b8a76.js";const l={},a=d(`<p>因为看不惯 Mixins 的多继承写法， 于是写了个类装饰器实现</p><div class="language-auto line-numbers-mode" data-ext="auto"><pre class="language-auto"><code>/**扩展合并 */
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function v(r,c){return n(),i("div",null,[s(" more "),a])}const u=e(l,[["render",v],["__file","装饰器：实现多继承.html.vue"]]);export{u as default};
