import{_ as s,r as a,o as t,c as e,e as p,a as o,f as c}from"./app-bb42a97e.js";const l={},r=c(`<p><strong>正确的做法</strong>是像 STL 容器那样，创建一个迭代器类，然后里面重载 <strong>!=（比较）， ++（递增），*（解引用）</strong> 这几个函数。</p><p>例如：</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">template</span> <span class="token operator">&lt;</span><span class="token keyword">class</span> <span class="token class-name">T</span><span class="token operator">&gt;</span>
...
<span class="token keyword">public</span><span class="token operator">:</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>之后我们就可以使用 <strong>for (auto&amp; i : xxx)</strong> 遍历这个类型的变量了，最后和大家说一下，<strong>如果 begin 和 end 是返回指针的话可以不用迭代器类</strong>就可以，因为指针的 !=（比较）, ++（自增），*（解引用）这几个函数都是 C++语言内置的。前提是你遍历的数据是连续内存，这样通过++（自增）获取的下个值才是正确的，不然你还是得额外写一个迭代器类。</p><hr><h3>📣 觉得很赞？分享给你的朋友吧！</h3>`,8);function i(u,d){const n=a("Share");return t(),e("div",null,[p(" more "),r,o(n,{services:"qq,qrcode",colorful:""})])}const v=s(l,[["render",i],["__file","C__用for遍历自定义类.html.vue"]]);export{v as default};
