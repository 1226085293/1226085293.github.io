import{_ as t,r as i,o as n,c as s,e as u,a as o,f as l}from"./app-ff7ac0ff.js";const r={},d=l(`<figure><img src="https://forum.cocos.org/uploads/default/original/3X/1/a/1a5e565a4796dbe52816402f307710827e7a6051.png" alt="" width="643" height="500" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>晚上试用了一下，</p><p>竟然支持我最爱的蛇形命名法<br><em>typescript-eslint + prettier</em></p><hr><p><em>配置如下，需要的可以根据自己习惯自行调整</em><br> package.json</p><div class="language-auto line-numbers-mode" data-ext="auto"><pre class="language-auto"><code>{
	&quot;type&quot;: &quot;module&quot;,
	&quot;devDependencies&quot;: {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>需要安装的需要把上面几个文件的内容复制到自己项目中，然后再 npm i ，再安装 vscode 内的 eslint 插件后重启 vscode 就行了</p><hr><h2 id="觉得很赞-分享给你的朋友吧" tabindex="-1"><a class="header-anchor" href="#觉得很赞-分享给你的朋友吧" aria-hidden="true">#</a> 📣 觉得很赞？分享给你的朋友吧！</h2>`,15);function a(c,v){const e=i("Share");return n(),s("div",null,[u(" more "),d,o(e,{services:"qq,qrcode",colorful:""})])}const m=t(r,[["render",a],["__file","typescript-eslint 太香了.html.vue"]]);export{m as default};
