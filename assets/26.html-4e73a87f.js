import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as t,c as e,e as p,d as o,f as c}from"./app-f451c3b3.js";const l={},r=c(`<p><strong>正确的做法</strong>是像 STL 容器那样，创建一个迭代器类，然后里面重载 <strong>!=（比较）， ++（递增），*（解引用）</strong> 这几个函数。</p><p>例如：</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">template</span> <span class="token operator">&lt;</span><span class="token keyword">class</span> <span class="token class-name">T</span><span class="token operator">&gt;</span>
