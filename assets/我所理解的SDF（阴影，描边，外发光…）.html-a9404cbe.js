...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="-3" tabindex="-1"><a class="header-anchor" href="#-3" aria-hidden="true">#</a></h3><p><strong>原理简介</strong>：<br> 从渲染点出发到光源点，依次步进安全距离（SDF 距离场，代表这个范围不会触碰到物体），<em>如果距离场 &lt; -hard<em>f</em> 则返回 0</em><br><em>具体实现方式可以看注释</em></p><hr><h2 id="结语" tabindex="-1"><a class="header-anchor" href="#结语" aria-hidden="true">#</a> # 结语</h2><h3 id="福音书-code" tabindex="-1"><a class="header-anchor" href="#福音书-code" aria-hidden="true">#</a> 福音书（Code）</h3><p><a href="https://github.com/1226085293/mk_sdf_shadow.git" rel="nofollow noopener">github</a></p><p><a href="https://gitee.com/muzzik/mk_sdf_shadow.git" rel="nofollow noopener">gitee</a></p><h3 id="参考代码" tabindex="-1"><a class="header-anchor" href="#参考代码" aria-hidden="true">#</a> 参考代码</h3><ul><li><a href="https://www.shadertoy.com/view/4dfXDn" rel="nofollow noopener">shadertoy2d 软阴影实现</a></li><li><a href="https://www.ronja-tutorials.com/post/037-2d-shadows/" rel="nofollow noopener">软阴影和硬阴影</a></li></ul><h3 id="推荐的-shader-调试网址" tabindex="-1"><a class="header-anchor" href="#推荐的-shader-调试网址" aria-hidden="true">#</a> 推荐的 shader 调试网址</h3><ul><li><a href="https://www.shadertoy.com/" rel="nofollow noopener">shadertoy 可以登录保存、分支代码，功能全面</a></li><li><a href="https://glslsandbox.com/" rel="nofollow noopener">glslsandbox 可以实时编译运行，但编辑器不太行</a></li></ul>`,84);function t(r,_){return e(),a("div",null,[d(" more "),l])}const o=i(s,[["render",t],["__file","我所理解的SDF（阴影，描边，外发光…）.html.vue"]]);export{o as default};
